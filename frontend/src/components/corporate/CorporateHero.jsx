...
export const CorporateHero = ({ onOpenModal }) => {
  return (
    <section 
      ...
      className="relative bg-[#F8FAFC] text-[#163758] pt-12 sm:pt-16 pb-16 sm:pb-20 lg:pb-24 overflow-hidden border-b border-slate-200/80"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl text-left">
          ...
          <div className="space-y-8">
            {/* Título ao lado esquerdo com as 3 dores corporativas */}
            <h2 
            ...
            <div className="border-l-4 border-[#1A73E8] pl-5 sm:pl-6 py-4 text-left bg-white rounded-r-xl border border-l-4 border-slate-200/80 shadow-2xs">
