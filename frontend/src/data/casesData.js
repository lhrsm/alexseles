...
export const casesData = [
...

  {
    ...
    cardHeadline: 'Redução do abandono de formulários, numa melhoria da experiência e na conquista do selo de ouro da AMA em usabilidade e acessibilidade.',
...

  {
    ...
    cardHeadline: 'Modernização de arquiteturas críticas e engenharia ágil com redução de 60% no time-to-market e alta disponibilidade.',
